...
export const clerkAppearance = {
  ...
  options: {
    ...
    logoImageUrl: `${window.location.origin}${basePath}/assets/logo-mark.png`,
  },
  variables: {
    colorPrimary: "#C9A439",
  ...
  elements: {
    ...
    footerActionLink: "text-[#C9A439] hover:text-[#D4B24A]",
    footerActionText: "text-[#A8A49B]",
    dividerText: "text-[#A8A49B]",
    identityPreviewEditButton: "text-[#C9A439]",
    ...
    formButtonPrimary: "bg-[#C9A439] hover:bg-[#B8942E] text-[#191919] font-medium",
